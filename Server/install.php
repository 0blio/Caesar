			...
			try {
				...
				$db -> execute ("
					...
					CREATE TABLE `targets` (
					  ...
					  `hostname` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
					  `username` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
					  `os` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
					  `arch` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
					  `ip` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
					  `first_request` datetime DEFAULT NULL,
					  `last_request` datetime DEFAULT NULL,
					  `working_directory` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
